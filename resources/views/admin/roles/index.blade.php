                    ...
                    @foreach ($roles as $role)
                        <tr class="odd:bg-slate-100">
                            ...
                            <td class="flex items-center justify-between">
                                <a href="{{ route('roles.show',$role->id) }}" title="{{ __('view daitl of role ').$role->name }}"><i class="icono text-blue-500 fa-solid fa-eye"></i></a>
                                <a href="{{ route('roles.edit',$role->id) }}" title="{{ __('edit role ').$role->name }}"><i class="icono text-green-500 fa-solid fa-pen-to-square"></i></a>
