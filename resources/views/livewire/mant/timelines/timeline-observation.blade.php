<article class="shadow-lg border border-gray-100 rounded p-2">
    <div class="card">
        <div class="card-body">
            <h1 class="text-xl font-bold text-gray-500 capitalize">{{ __("observation") }}</h1>
            <hr class="mt-2 mb-3">
            <form action=""wire:submit.prevent="saveObservation">
                <textarea placeholder="{{ __("input observation") }}" wire:model="observation" class="rounded w-full h-full"></textarea>
                <div class="mb-4">
