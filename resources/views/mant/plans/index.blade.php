                        ...
                        <tr class="even:bg-gray-100 odd:bg-gray-200">
                            <td width="40%">
                                <div>
                                    ...
                                    <p class="text-gray-600 font-semibold text-sm">Fecha de Inicio:
                                        <strong>{{ $plan->start->format('d-m-Y') }}</strong>
                                    </p>
                                    <p class="text-gray-600 font-semibold text-sm">Hora de Inicio:
                                        <strong>{{ $plan->start_time->format('h:i A') }}</strong>
                                    </p>
                                    <p class="text-gray-600 font-semibold text-sm">Turnos laborables:
                                        <strong>{{ $plan->work_shift }} turnos</strong>
                                    </p>
                                    <p class="text-gray-600 font-semibold text-sm">Horas laborables semanalmente:
                                        <strong>{{ $plan->weekly_shift }} horas</strong>
                                    </p>
                                    <p class="text-gray-600 font-semibold text-sm">Horario de Inicio:
                                        <strong>{{ $plan->work_time->format('h:i A') }}</strong>
                                    </p>
                                    <p class="text-gray-600 font-semibold text-sm">Horas laborables diarias:
                                        <strong>{{ $plan->daily_shift }} horas</strong>
                                    </p>
                                    <p class="text-gray-600 font-semibold text-sm">Hora de descanso:
                                    ...
                                    <p class="text-gray-600 font-semibold text-sm">trabajo en feriado:
                                        <strong>{{ $plan->work_holiday ? 'si' : 'no' }}</strong>
                                    </p>
                                    <p class="text-gray-600 font-semibold text-sm">Trabajo de sobretiempo:
