            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-3 gap-2 text-xs">
                        ...
                        <div class="mb-4">
                            <x-jet-label class="italic my-2 capitalize" value="{{ __('permissions') }}" for="name" />
                        ...
                        <div class="mb-4">
                            <x-jet-label class="italic my-2 capitalize" value="{{ __('security') }}" for="name" />
                        ...
                        <div class="mb-4">
                            <x-jet-label class="italic my-2 capitalize" value="{{ __('conditions') }}" for="conditions" />
